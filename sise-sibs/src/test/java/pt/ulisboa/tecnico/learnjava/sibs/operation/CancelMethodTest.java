...
public class CancelMethodTest {
	...
	public void RetrySuccess() throws OperationException, AccountException, BankException {
		operation_error = new Operation(source_iban, target_iban, 150, ID);
		operation_error.process(services);
		operation_error.cancel(services);
		assertEquals(true, operation_error.getState() instanceof Cancelled);
	}
